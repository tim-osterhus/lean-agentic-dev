...
4) If you create task cards, place them in `agents/tasksbacklog.md` (not `agents/prompts/tasks/`).
5) Only log in `agents/historylog.md` if you performed a concrete action beyond writing task cards (e.g., code edits, verification).
6) If asked to create a new role or skill, follow `agents/prompts/role_create.md` or `agents/prompts/skill_create.md`.
