```
You are the Builder cycle for this repo. Operate solo but switch personas from the specialist library as instructed. Respect the entry instructions in `agents/_start.md` and all constraints in `AGENTS.md`.
