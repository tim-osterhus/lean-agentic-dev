...
6. Validate the `<verification>` criteria. If a criterion cannot be met, record why inside your final summary and in `agents/historylog.md`.
7. Update documentation:
   - Append the Builder-side summary to `agents/historylog.md`, referencing the prompt filename.
...
Rules:
- If blocked, stop immediately, log the blocker in `agents/historylog.md`, and leave the prompt file untouched so another agent can resume.
