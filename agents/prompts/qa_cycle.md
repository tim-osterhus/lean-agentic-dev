...
4. Write `agents/expectations.md` describing the optimal outcome:
...
Phase B — Validation:
5. With expectations documented, inspect the actual repo state and `agents/historylog.md`.
6. Run or request critical tests; record commands and results.
7. Compare reality vs expectations. Be explicit about matches, partial matches, and gaps.

Phase C — Outcomes:
8. If everything aligns, write a short confirmation note.
9. If gaps exist, activate the **Fullstack Glue Specialist** to author `agents/quickfix.md`:
