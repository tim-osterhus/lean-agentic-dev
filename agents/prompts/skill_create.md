...
2) Fill `SKILL.md` with concrete, project-relevant details.
3) Add at least one example to `EXAMPLES.md` using the template format.
4) Update `agents/skills/skills_index.md` with the new skill entry.
